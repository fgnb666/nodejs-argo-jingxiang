...
const FILE_PATH = process.env.FILE_PATH || '/tmp/vls';   // 运行目录,sub节点文件保存目录
const SUB_PATH = process.env.SUB_PATH || 'sub';       // 订阅路径
const PORT = process.env.SERVER_PORT || process.env.PORT || 7860;        // http服务订阅端口
const UUID = process.env.UUID || 'dd592512-5d9a-4e17-b097-e463587aeda2'; // 使用哪吒v1,在不同的平台运行需修改UUID,否则会覆盖
